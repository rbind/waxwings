...
* Or not, but there's some other fun stuff in there: ['Goodreads `r emo::ji_glue(":thumbsup:")``r emo::ji_glue(":books:")` Part 2: rvesting descriptions'](https://maraaverick.rbind.io/2017/10/goodreads-part-2/)
