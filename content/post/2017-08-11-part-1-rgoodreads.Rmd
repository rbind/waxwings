...
tags:
  - R
description: "There are very few things considered normal (in the ordinary sense of the word) about my reading habits. Let's just say that, when I saw `#BokLoversDay` ws trending on Twitter, my first thought was: _itme!_ Hwever, it also served as a reminder of my struggles regarding reading and normalcy"
---
...
It's not quite as bad as I'd feared 🙀. But, in the next part, we'll take a closer look at if my quest for (faux) reading-normalcy has been a success.
