...
Updated: `r emo::ji("calendar")` 2018-04-06.
...
`r emo::ji("new")` An RStudio addin by [Garrick Aden-Buie](https://www.garrickadenbuie.com/), [**RegExplain**](https://www.garrickadenbuie.com/project/regexplain/), looks like it will be an invaluable companion to go along with the other resources collected here.

![](https://i.imgur.com/iGnEpPV.gif)

Below you'll find a collection of some of the Regex-related links I've tweeted `r emo::ji("bird")`:
