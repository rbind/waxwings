...
This is _not_ the post I originally intended to write about the [**rOpenSci Unconf**](http://unconf17.ropensci.org/) (and, I promise, this isn't just a lame attempt to take the Magritte joke a step further). Rather, what follows is wisdom gleaned both at the unconf, and in in my (failed) attempts to write the aforementioned original post capturing my unconf experience.[^1]
