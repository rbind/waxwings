...
Stopping `r emo::ji("stop")`, however, did not go so well. Na matter how many times I ran `vagrant halt`, I could **not** get it to work. I read and re-read the documentation, looked at answers on StackOverflow, went through the whole _thing on a computer isn't working right_ routine many of us know so well.
