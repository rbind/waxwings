...
tags:
  - ggplot2
banner: "banners/papyrus_rain.gif"
...
So I did what I had to do. I pulled the [appropriate data](http://www.boxofficemojo.com/movies/?page=weekly&id=avatar.htm&sort=weeknum&order=ASC&p=.htm) data from [Box Office Mojo](http://www.boxofficemojo.com/), and made it all nice and R-friendly using Miles McBain's [`datapasta`](https://github.com/MilesMcBain/datapasta) package/addin.
