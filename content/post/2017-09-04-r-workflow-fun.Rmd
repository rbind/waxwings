...
### [represtools: Reproducible research tools](http://pirategrunt.com/represtools/) by PirateGrunt[^PG]
...
[^PG]: I'm pretty sure that's not his given name, but I can't find another. So, [PirateGrunt](http://pirategrunt.com/) it is... `r emo::ji("skull")`